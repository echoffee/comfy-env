...
export PS1="\[\e[01;34m\] \${PWD##*/}\[\e[01;31m\]\$(parse_git_branch)\[\e[01;32m\] >> \[\e[m\]"
# broken vvvv
# export PS1=$(printf "%*s\r%s" $(( COLUMNS-1 )) "\${PWD##*/}" "\[\e[01;32m\] >> \[\e[m\]")

export LS_COLORS=$(cat ~/config/colors_policy.config)
